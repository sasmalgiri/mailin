    ...
    private var personaCoreFeatureTiles: [(HubDestination, String, String, String, Color)] {
        ...
        case .forensic:
            return [
                ...
                (.investigationReport, "Investigation Reports", "Structured investigation documents", "doc.text.magnifyingglass", .red),
            ]
        case .legal:
            return [
    ...
    private var legalForensicSection: some View {
        VStack(alignment: .leading, spacing: Spacing.small) {
            ...
            LazyVGrid(columns: featureColumns, spacing: Spacing.small) {
                ...
                hubTile(dest: .investigationReport, title: "Investigation Report", subtitle: "Structured documents",
