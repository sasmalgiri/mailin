...
extension FeatureTutorial {
    ...
    static let gdprCompliance = FeatureTutorial(
        ...
        steps: [
            ...
            TutorialStep(title: "Generate Report", icon: "doc.richtext", color: .purple,
                ...
                how: "Click Generate to produce a report supporting GDPR data subject access workflows — listing personal data found for the specified data subject. The report includes data categories, sources, retention periods, and processing bases. Final compliance review is your responsibility.",
    ...
    static let batesNumbering = FeatureTutorial(
        ...
        overview: "Bates Numbering assigns unique, sequential identifiers to every email in your archive for document management workflows. These tamper-evident identifiers (e.g., CASE001-000001) support precise document referencing in case files, depositions, and production sets. Admissibility in any specific proceeding remains subject to applicable jurisdictional rules — consult counsel.",
