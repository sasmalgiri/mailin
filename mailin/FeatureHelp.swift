...
extension HubDestination {
    ...
    var caption: String {
        ...
        case .forensicReview:       return "Forensic evidence coding and integrity verification workflow."
...
enum GlossaryTerm: String, CaseIterable, Identifiable {
    ...
    var definition: String {
        switch self {
        case .batesNumbering:
            return "Sequential numbers stamped on documents during legal production so each page has a unique reference. For example, ABC000001, ABC000002, ABC000003. Widely used in legal filings; specific format requirements vary by jurisdiction."
        case .chainOfCustody:
            return "A tamper-evident log of who accessed, modified, or exported each piece of evidence and when. Commonly used to support evidentiary workflows; admissibility in any specific proceeding remains subject to applicable rules."
        case .custodian:
        ...
        case .privilege:
            return "Communications between an attorney and their client that may be protected from disclosure under applicable privilege rules. Marking them privileged in mailin tags them for exclusion from production sets; final privilege determinations require attorney review."
        case .redaction:
