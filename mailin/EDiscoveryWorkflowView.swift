                ...
                VStack(alignment: .leading, spacing: Spacing.large) {
                    ...
                    VStack(alignment: .leading, spacing: Spacing.medium) {
                        ...
                        tutorialPhaseRow(
                            ...
                            tip: "This creates a tamper-evident chain-of-custody record that supports workflows used in legal proceedings. Admissibility is determined by applicable jurisdictional rules — consult counsel."
                        )
